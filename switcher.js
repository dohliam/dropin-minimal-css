var frameworks = "awsm,base,bullframe,bulma,cardinal,caramel,caiuss,concise,flat-ui,furtive,html-starterkit,kathamo,kube,lotus,markdown,milligram,min,mini,motherplate,mui,normalize,oh-my-css,papier,pavilion,picnic,pure,sanitize-10up,sanitize-zdroid,semantic-ui,siimple,simple,skeleton-framework,skeleton-plus,skeleton,spectre,tachyons,tacit,tent,thao,vital,wing,ads-gazette,ads-medium,ads-notebook,ads-tufte,boot-cerulean,boot-cosmo,boot-cyborg,boot-darkly,boot-flatly,boot-journal,boot-lumen,boot-paper,boot-readable,boot-sandstone,boot-slate,boot-spacelab,boot-superhero,boot-yeti";
