var frameworks = "air,awsm,bare,base,bullframe,bulma,caiuss,caramel,cardinal,chota,clmaterial,concise,flat-ui,fluidity,furtive,generic,hack,html-starterkit,kathamo,kube,lit,lotus,markdown,marx,mercury,milligram,min,mini,modest,motherplate,mui,normalize,oh-my-css,paper,papier,pavilion,picnic,pure,sakura,sanitize-10up,sanitize-zdroid,semantic-ui,shoelace,siimple,simple,skeleton,skeleton-framework,skeleton-plus,spectre,splendor,style,tachyons,tacit,tent,thao,vital,wing,writ,ads-gazette,ads-medium,ads-notebook,ads-tufte,boot-cerulean,boot-cosmo,boot-cyborg,boot-darkly,boot-flatly,boot-journal,boot-lumen,boot-paper,boot-readable,boot-sandstone,boot-slate,boot-spacelab,boot-superhero,boot-yeti";
